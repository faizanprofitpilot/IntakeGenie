...
export const STATE_DESCRIPTIONS: Record<string, string> = {
  ...
  CONTACT_EMAIL: `Check filled.email first. If present, skip to REASON immediately. Otherwise, skip this state entirely (email is optional). Only ask if user offers it.`,
